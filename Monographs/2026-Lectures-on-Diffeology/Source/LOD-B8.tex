...
\addcontentsline{toc}{chapter}{Non-symplectic manifold with injective univ. moment map}
\chaptermark{Non-symplectic manifold with injective\dots}
...
%\vfill\n
%\centerline{\includegraphics[width=.5\textwidth]{Figures/separator.jpg}}\n
