...
%% \CHO : Chain-Homotopy operator (K)
\newcommand{\CHO}{\mathsf{K}}

%% \Komega : Action 1-form on the space of paths
\newcommand{\Komega}{\CHO\omega}

%% \bfCHO : Bold variant of chain-homotopy operator
\newcommand{\bfCHO}{\boldsymbol{\mathsf K}}
