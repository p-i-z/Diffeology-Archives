...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
%% MARK: Volumes and Surface forms
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% The volume form of a manifold of any dimension
...
%% \EndsPath : The pair of endpoints of a path (a value in X × X)
%% Usage: \EndsPath(\gamma) = (\0(\gamma), \1(\gamma))
%% This is a function \Paths(X) → X × X.
%% For the map as a morphism, use \EndsMap.
\def\EndsPath(#1){(\0(#1),\1(#1))}

%% \EndsMap : The ends map as a smooth morphism between diffeological spaces
%% Usage: \EndsMap : \Paths(X) → X × X is a subduction
%% Semantically the same as \EndsPath, but emphasizes the map as an object
%% in the category of diffeological spaces.
\newcommand{\EndsMap}{\operatorname{ends}}

%% [Deprecated] \Ends : Old notation, replaced by \EndsPath and \EndsMap
 \def\Ends{\operatorname{ends}}

%% The values of a path at time $t$: \tValue{\gamma}
\newcommand{\tValue}{\hat{t}} % \time(\gamma)  = \gamma(t)
