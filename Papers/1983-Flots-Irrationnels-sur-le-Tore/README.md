...
*   **`DIZ83.tex`**: The modern, living LaTeX source file. This version has been transcribed and formatted for modern compilation and serves as the basis for any future corrections or updates.
    *   *Note:* The two commutative diagrams present in the original paper have not yet been recreated in this modern source file. For the visual representation of these diagrams, please refer to the scanned PDFs. A future update may include TikZ versions.
