...
\begin{document}
  ...
  \begin{article}\artlabel[The Groupoid Structure]
    ...
    However,
    following the principle of the \emph{Universality of the Quantum Unit} (Part II, \textsection 7),
    we impose the universal period $h$ (Planck's constant) on the action variable.
    
    The prequantum groupoid $\TT_\omega$ is the additive groupoid over $X$,
