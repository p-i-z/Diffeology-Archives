...
$$
where $\Delta_\alpha(g) = g \circ \R_\alpha - g$ is the operator at the heart of the classical cohomological equation for circle rotations. This theorem establishes a direct and profound link between the intrinsic geometry of $\T_\alpha$ and the arithmetic nature of its defining slope $\alpha$:

1.  **For Diophantine $\alpha$**, the cokernel vanishes, and $\Fb(\T_\alpha, \RR) \simeq \RR$. In this "tame" geometric case, every flow can be described by an infinitesimal connection.
